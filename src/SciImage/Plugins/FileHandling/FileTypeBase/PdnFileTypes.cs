...
using SciImage.Plugins.FileHandling.InternalTypes;

namespace SciImage.Plugins.FileHandling.FileTypeBase
{
    /// <summary>
        ...
        : IFileTypeFactory
    {
        ...
        public static readonly FileType Pdn = new SciFileType();
