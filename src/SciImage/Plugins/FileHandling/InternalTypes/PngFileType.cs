...
{ 
        ...
        : InternalFileType
    {
        ...
        protected override PropertyBasedSaveConfigWidget OnCreateSaveConfigWidgetT()
        {
        ...
        //        SciImage.SciResource.SciResources.GetString("PngFileType.ConfigUI.BitDepth.DisplayName"));

        //    PropertyControlInfo bitDepthPCI = configUI.FindControlForPropertyName(PropertyNames.BitDepth);
        //    bitDepthPCI.SetValueDisplayName(PngBitDepthUIChoices.AutoDetect, SciImage.SciResource.SciResources.GetString("PngFileType.ConfigUI.BitDepth.AutoDetect.DisplayName"));
        //    bitDepthPCI.SetValueDisplayName(PngBitDepthUIChoices.Bpp32, SciImage.SciResource.SciResources.GetString("PngFileType.ConfigUI.BitDepth.Bpp32.DisplayName"));
        //    bitDepthPCI.SetValueDisplayName(PngBitDepthUIChoices.Bpp24, SciImage.SciResource.SciResources.GetString("PngFileType.ConfigUI.BitDepth.Bpp24.DisplayName"));
        //    bitDepthPCI.SetValueDisplayName(PngBitDepthUIChoices.Bpp8, SciImage.SciResource.SciResources.GetString("PngFileType.ConfigUI.BitDepth.Bpp8.DisplayName"));
        ...
        //        ControlInfoPropertyNames.DisplayName,
        //        SciImage.SciResource.SciResources.GetString("PngFileType.ConfigUI.DitherLevel.DisplayName"));

        //    configUI.SetPropertyControlValue(
        //        PropertyNames.Threshold,
        //        ControlInfoPropertyNames.DisplayName,
        //        SciImage.SciResource.SciResources.GetString("PngFileType.ConfigUI.Threshold.DisplayName"));

        //    configUI.SetPropertyControlValue(
        //        PropertyNames.Threshold,
        //        ControlInfoPropertyNames.Description,
        //        SciImage.SciResource.SciResources.GetString("PngFileType.ConfigUI.Threshold.Description"));
        ...
        {
            using (Image image = SciResources.SciResources.LoadImage(input))
            {
