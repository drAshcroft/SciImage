...
namespace SciImage.Plugins.Tools.DefaultTools
{
        ...
        : MoveToolBase
    {
        ...
        // if this equals false, then Render() will always use NearestNeighbor, regardless of ToolEnvironment.ResamplingAlgorithm
        ...
        protected override void OnActivate()
        {
            ...
            this.moveToolCursor = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.MoveToolCursor.cur"));
        ...
        public void PasteMouseDown(SurfaceForClipboard sfc, Point offset)
        {
            ...
            SciRegion pasteRegion = new SciRegion(pastePath);

            SciRegion simplifiedPasteRegion = Utility.SimplifyAndInflateRegion(pasteRegion);
        ...
        protected override void OnLift(MouseEventArgs e)
        {
            ...
            SciRegion liftRegion = Selection.CreateRegion();
            ...
            {
                ColorPixelBase fill = ToolEnvironment.SecondaryColor;
                fill.alpha  = 0;
                UnaryPixelOp op = new Constant(fill);
        ...
        protected void Render(Point newOffset, bool useNewOffset, bool saveRegion)
        {
            ...
            SciRegion selectedRegion = Selection.CreateRegion();
            SciRegion simplifiedRegion = Utility.SimplifyAndInflateRegion(selectedRegion);
            ...
            if (this.fullQuality && ToolEnvironment.ResamplingAlgorithm == ResamplingAlgorithm.Bilinear)
            {
            ...
            if (this.activeLayer.GetType () == typeof (BitmapLayer ))
            {
                this.ourContext.LiftedPixels.Draw(
                    ...
                    this.fullQuality ?
                        ToolEnvironment.ResamplingAlgorithm :
        ...
        protected override void OnMouseUp(MouseEventArgs e)
        {
            ...
            string actionName = SciResources.SciResources.GetString(resourceName);
        ...
        private void FlushHistoryMementos(string name)
        {
            if (this.currentHistoryMementos.Count > 0)
            {
                ...
                {
                    haName = "Paste";
                    image = SciResources.SciResources.GetImageResource("Icons.MenuEditPasteIcon.png");
                    this.didPaste = false;
                }
                else
                {
        ...
        public MoveTool(DocumentWorkspace documentWorkspace)
            : base(documentWorkspace,
                   SciResources.SciResources.GetImageResource("Icons.glyphicons-187-move.png"),
                   MoveTool.StaticName,
