        ...
        : Tool
    {
        ...
        protected void PositionNubs(Mode currentMode)
        {
            if (this.moveNubs == null)
            {
                ...
                this.moveNubs[(int)Edge.TopLeft].Shape = MoveNubRenderer.MoveNubShape.Circle;
                ...
                this.moveNubs[(int)Edge.TopRight].Shape = MoveNubRenderer.MoveNubShape.Circle;
                ...
                this.moveNubs[(int)Edge.BottomLeft].Shape = MoveNubRenderer.MoveNubShape.Circle;
                ...
                this.moveNubs[(int)Edge.BottomRight].Shape = MoveNubRenderer.MoveNubShape.Circle;
            }
        ...
        public MoveToolBase(DocumentWorkspace documentWorkspace, ImageResource toolBarImage, string name, 
            ...
            : base(documentWorkspace, toolBarImage, name, helpText, hotKey,order, skipIfActiveOnHotKey, toolBarConfigItems)
        {
        }
    }
}
