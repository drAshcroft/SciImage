...
namespace SciImage.Plugins.Tools.InternalTools
{
        ...
        : Tool
    {
        ...
        protected override void OnActivate()
        {
            ...
            cursorMouseUp = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.RecoloringToolCursor.cur"));
            cursorMouseDown = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.GenericToolCursorMouseDown.cur"));
            cursorMouseDownPickColor = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.RecoloringToolCursorPickColor.cur"));
            cursorMouseDownAdjustColor = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.RecoloringToolCursorAdjustColor.cur"));
        ...
        public RecolorTool(DocumentWorkspace documentWorkspace)
            : base(documentWorkspace,
                   SciResources.SciResources.GetImageResource("Icons.RecoloringToolIcon.png"),
                   "Switch Colors", 
