...
namespace SciImage.Plugins.Tools.InternalTools
{
        ...
        : FloodToolBase
    {
        ...
        protected override void OnActivate()
        {
            ...
            try
            {
                this.cursorMouseUp = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.MagicWandToolCursor.cur"));
                this.cursorMouseUpMinus = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.MagicWandToolCursorMinus.cur"));
                this.cursorMouseUpPlus = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.MagicWandToolCursorPlus.cur"));
            }
            catch { }
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            ...
            {
                this.combineMode = ToolEnvironment.SelectionCombineMode;
            }
        ...
        public MagicWandTool(DocumentWorkspace documentWorkspace)
            : base(documentWorkspace,
                   SciResources.SciResources.GetImageResource("Icons.MagicWandToolIcon.png"),
