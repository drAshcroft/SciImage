...
namespace SciImage.Plugins.Tools.InternalTools
{
        ...
        : Tool
    {
        ...
        protected override void OnActivate()
        {
            ...
            // cursor-transitions
            this.cursorMouseUp = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.EraserToolCursor.cur"));
            this.cursorMouseDown = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.EraserToolCursorMouseDown.cur"));
        ...
        public EraserTool(DocumentWorkspace documentWorkspace) 
            : base(documentWorkspace,
                   SciResources.SciResources.GetImageResource("Icons.EraserToolIcon.png"),
                   "Rub out tool",
