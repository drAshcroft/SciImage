...
namespace SciImage.Plugins.Tools.InternalTools
{
        ...
        : MoveToolBase
    {
        ...
        protected override void OnActivate()
        {
            ...
            this.moveToolCursor = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.MoveSelectionToolCursor.cur"));
        ...
        protected override void Drop()
        {
            ...
            this.FlushHistoryMementos(SciResources.SciResources.GetString("MoveSelectionTool.HistoryMemento.DropSelection"));
        }
        ...
        public MoveSelectionTool(DocumentWorkspace documentWorkspace)
            : base(documentWorkspace,
                   SciResources.SciResources.GetImageResource("Icons.MoveSelectionToolIcon.png"),
