...
namespace SciImage.Plugins.Tools.InternalTools
{
        ...
        : Tool 
    {
        ...
        protected override void OnActivate()
        {
            ...
            cursorMouseUp = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.PaintBrushToolCursor.cur"));
            cursorMouseDown = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.PaintBrushToolCursorMouseDown.cur"));
        ...
        {
            return Pressure * Pressure * ToolEnvironment.PenInfo.Width * 0.5f;
        }
        ...
        protected override void OnStylusDown(StylusEventArgs e)
        {
                ...
                ((e.Button & MouseButtons.Right) == MouseButtons.Right))
            {
                ...
                {
                    brush = ToolEnvironment.CreateBrush(false);
                }
                else if ((mouseButton & MouseButtons.Right) == MouseButtons.Right)
                {
                    brush = ToolEnvironment.CreateBrush(true);
                }
        ...
        protected override void OnStylusUp(StylusEventArgs e)
        {
            ...
            if (mouseDown)
            {
                ...
                {
                    SciRegion saveMeRegion = Utility.RectanglesToRegion(this.savedRects.ToArray());
        ...
        public PaintBrushTool(DocumentWorkspace documentWorkspace)
            : base(documentWorkspace,
                   SciResources.SciResources.GetImageResource("Icons.PaintBrushToolIcon.png"),
                   "Paint Brush",
                   "Draw",
                   'b',
                   false,
