...
namespace SciImage.Plugins.Tools.InternalTools
{
        ...
        : Tool
    {
        ...
        protected override void OnActivate()
        {
            ...
            this.cursorMouseDown = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.PanToolCursorMouseDown.cur"));
            this.cursorMouseUp = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.PanToolCursor.cur"));
            this.cursorMouseInvalid = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.PanToolCursorInvalid.cur"));
        ...
        public PanTool(DocumentWorkspace documentWorkspace)
            : base(documentWorkspace,
                   SciResources.SciResources.GetImageResource("Icons.PanToolIcon.png"),
                   "Pan",
