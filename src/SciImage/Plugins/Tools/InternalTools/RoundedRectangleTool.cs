...
namespace SciImage.Plugins.Tools.InternalTools
{
        ...
        : ShapeTool 
    {
        ...
        {
            this.roundedRectangleCursor = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.RoundedRectangleToolCursor.cur"));
        ...
        public RoundedRectangleTool(DocumentWorkspace documentWorkspace)
            : base(documentWorkspace,
                   SciResources.SciResources.GetImageResource("Icons.RoundedRectangleToolIcon.png"),
                   "Rounded Rectangle",
