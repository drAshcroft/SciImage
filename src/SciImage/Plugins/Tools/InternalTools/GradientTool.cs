...
namespace SciImage.Plugins.Tools.InternalTools
{
        ...
        : Tool
    {
        ...
        public static ImageResource StaticImage
        {
            get
            {
                return SciResources.SciResources.GetImageResource("Icons.GradientToolIcon.png");
            }
        }
        ...
        {
            this.toolCursor = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.GenericToolCursor.cur"));
            this.toolMouseDownCursor = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.GenericToolCursorMouseDown.cur"));
