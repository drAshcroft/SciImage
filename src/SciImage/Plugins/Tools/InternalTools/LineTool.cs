        ...
        : ShapeTool 
    {
        ...
        protected override PdnGraphicsPath CreateShapePath(PointF[] points)
        {
            ...
            else //if (points.Length <= 2)
            {
                ...
                if (units != MeasurementUnit.Pixel)
                {
                    ...
                    unitsAbbreviation = SciResources.SciResources.GetString(unitsAbbreviationName);
                    numberFormat = "F2";
                }
                else
                {
        ...
        protected override bool OnWildShortcutKey(int ordinal)
        {
            switch (ordinal)
            {
                case toggleStartCapOrdinal:
                    AppEnvironment.Environment.ToolConfigStrip.CyclePenStartCap();
                    return true;

                case toggleDashOrdinal:
                    AppEnvironment.Environment.ToolConfigStrip.CyclePenDashStyle();
                    return true;

                case toggleEndCapOrdinal:
                    AppEnvironment.Environment.ToolConfigStrip.CyclePenEndCap();
                    return true;
            }
        ...
        protected override bool OnShapeEnd()
        {
            ...
            else
            {
                ...
                string helpText2 = SciResources.SciResources.GetString("LineTool.PreCurveHelpText");
        ...
        protected override void OnStylusDown(StylusEventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    string helpText2 = SciResources.SciResources.GetString("LineTool.CurvingHelpText");
        ...
        {
            this.lineToolCursor = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.LineToolCursor.cur"));
            this.lineToolMouseDownCursor = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.GenericToolCursorMouseDown.cur"));
            this.Cursor = this.lineToolCursor;
        ...
        public LineTool(DocumentWorkspace documentWorkspace)
            : base(documentWorkspace,
                   SciResources.SciResources.GetImageResource("Icons.LineToolIcon.png"),
                   "Line / Curve",
