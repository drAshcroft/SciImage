...
namespace SciImage.Plugins.Tools.InternalTools
{
    public class ColorPickerTool : Tool
    {
        ...
        {
            this.colorPickerToolCursor = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.ColorPickerToolCursor.cur"));
        ...
        public ColorPickerTool(DocumentWorkspace documentWorkspace)
            : base(documentWorkspace,
                   SciResources.SciResources.GetImageResource("Icons.ColorPickerToolIcon.png"),
                   "Color sampler",
