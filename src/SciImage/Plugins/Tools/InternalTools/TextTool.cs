...
namespace SciImage.Plugins.Tools.InternalTools
{
        ...
        : Tool
    {
        ...
        protected override void OnActivate()
        {
            ...
            this.textToolCursor = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.TextToolCursor.cur"));
        ...
        private void UpdateStatusText()
        {
            ...
            {
                text = SciResources.SciResources.GetString("TextTool.StatusText.StartTyping");
                image = null;
            }
        ...
        public TextTool(DocumentWorkspace documentWorkspace)
            : base(documentWorkspace,
                   SciResources.SciResources.GetImageResource("Icons.TextToolIcon.png"),
                   "Text Stamp",
