...
namespace SciImage.Plugins.Tools.InternalTools
{
        ...
        : Tool
    {
                       ...
                       ~(toolBarConfigItemsExclude))
        {
            ...
            this.points = null;
            this.cursorMouseUp = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.ShapeToolCursor.cur"));
            this.cursorMouseDown = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.ShapeToolCursorMouseDown.cur"));
        }
