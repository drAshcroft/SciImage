...
namespace SciImage.Plugins.Tools.InternalTools
{
        ...
        : ShapeTool 
    {
        ...
        {
            this.freeformShapeToolCursor = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.FreeformShapeToolCursor.cur"));
        ...
        public FreeformShapeTool(DocumentWorkspace documentWorkspace)
            : base(documentWorkspace,
                   SciResources.SciResources.GetImageResource("Icons.FreeformShapeToolIcon.png"),
