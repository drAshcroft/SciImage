        ...
        : Tool
    {
        ...
        public ZoomTool(DocumentWorkspace documentWorkspace)
            : base(documentWorkspace,
                   SciResources.SciResources.GetImageResource("Icons.ZoomToolIcon.png"),
                   "Zoom",
        ...
        {
            this.cursorZoom = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.ZoomToolCursor.cur"));
            this.cursorZoomIn = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.ZoomInToolCursor.cur"));
            this.cursorZoomOut = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.ZoomOutToolCursor.cur"));
            this.cursorZoomPan = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.ZoomOutToolCursor.cur"));
