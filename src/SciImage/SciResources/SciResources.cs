...
{
    public static class SciResources
    {
        private static ResourceManager resourceManager;
        private const string ourNamespace = "SciImage.SciResources";
        private static Assembly ourAssembly;
        private static string[] localeDirs;
        private static CultureInfo sciCulture;
        ...
        public static string ResourcesDir
        {
            get
            {
                ...
                {
                    resourcesDir = Path.GetDirectoryName(typeof(SciResources).Assembly.Location);
                }
        ...
        private static void Initialize()
        {
            ...
            sciCulture = CultureInfo.CurrentUICulture;
        ...
        public static void SetNewCulture(string newLocaleName)
        {
            ...
            string oldUserDataPath = SciInfo.UserDataPath;
            string oldPaletteDirName = SciResources.GetString("ColorPalettes.UserDataSubDirName");
            // END HACK
            ...
            string newUserDataPath = SciInfo.UserDataPath;
            string newPaletteDirName = SciResources.GetString("ColorPalettes.UserDataSubDirName");
        ...
        public static string GetString(string stringName)
        {
            try
            {
                string theString = resourceManager.GetString(stringName, sciCulture);
            ...
            {
                return stringName;// builder.ToString();
            }
        }
        ...
        private sealed class SciImageResource : ImageResource
        {
            private string name;
            ...
            {
                return SciResources.GetImage(this.name);
            }
            ...
            static SciImageResource()
            {
                images = new Dictionary<string, ImageResource>();
            }

            private SciImageResource(string name)
                : base()
            {
                this.name = name;
            }

            private SciImageResource(Image image)
                : base(image)
            {
                this.name = null;
            }
        ...
        public static ImageResource GetImageResource(string fileName)
        {
            ...
            return SciImageResource.Get(  fileName);
        }
