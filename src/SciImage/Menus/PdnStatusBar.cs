...
{
    public sealed class SciStatusBar
        : StatusStrip, 
          IStatusBarProgress
    {
        public static  readonly string CursorInfoStatusBarFormat = "x,y {0}{1}, {2}{3}";
        public static  readonly string ImageInfoStatusBarFormat = "({0}{1} x {2}{3})";
        ...
        public SciStatusBar()
        {
            ...
            this.cursorInfoStatusLabel.Image = SciResources.SciResources.GetImageResource("Icons.CursorXYIcon.png").Reference;
            this.cursorInfoStatusLabel.Text = string.Empty;

            // imageInfo (width,height info)
            this.imageInfoStatusLabel.Image = SciResources.SciResources.GetImageResource("Icons.ImageSizeIcon.png").Reference;
