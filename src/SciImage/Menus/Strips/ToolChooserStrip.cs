...
namespace SciImage.Menus.Strips
{
          ...
          IToolChooser
    {
        ...
        private ToolMenuInfo[] toolInfos = null;
        ...
        {
            this.chooseToolLabelText = "&Choose Tool:";
            InitializeComponent();
        }
        ...
        {
            ToolMenuInfo ti = e.ClickedItem.Tag as ToolMenuInfo;
        ...
        private void ChooseToolButton_DropDownOpening(object sender, EventArgs e)
        {
            ...
            {
                string chooseToolText = SciResources.SciResources.GetString("ToolChooserStrip.ChooseToolDefaults.Text");
                ImageResource chooseToolIcon = SciResources.SciResources.GetImageResource("Icons.MenuLayersLayerPropertiesIcon.png");
        ...
        public void SelectTool(Type toolType, bool raiseEvent)
        {
            ...
            try
            {
                ...
                {
                    foreach (ToolMenuInfo ti in this.toolInfos)
                    {
        ...
        public void SetTools(ToolMenuInfo[] newToolInfos)
        {
