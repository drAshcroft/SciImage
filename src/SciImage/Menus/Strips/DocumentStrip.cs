...
namespace SciImage.Menus.Strips
{
          ...
          IDocumentList
    {
        ...
        {
            SciBaseForm.RegisterFormHotKey(Keys.Control | Keys.Tab, OnNextTabHotKeyPressed);
            SciBaseForm.RegisterFormHotKey(Keys.Control | Keys.PageDown, OnNextTabHotKeyPressed);
            SciBaseForm.RegisterFormHotKey(Keys.Control | Keys.Shift | Keys.Tab, OnPreviousTabHotKeyPressed);
            SciBaseForm.RegisterFormHotKey(Keys.Control | Keys.PageUp, OnPreviousTabHotKeyPressed);
            ...
            for (int i = 0; i <= 9; ++i)
            {
                ...
                SciBaseForm.RegisterFormHotKey(Keys.Control | digit, OnDigitHotKeyPressed);
                SciBaseForm.RegisterFormHotKey(Keys.Alt | digit, OnDigitHotKeyPressed);
            }
