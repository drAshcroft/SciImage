...
using SciImage.Plugins.Tools.ToolConfigs;
...
using SciImage.SystemLayer.Threading;
using ThreadPool = System.Threading.ThreadPool;

namespace SciImage.Menus.Strips
{
    //todo:  this needs to die and each tool should define the config for that tool
          ...
          ISelectionDrawModeConfig
    {
        ...
        public ToolConfigStrip()
        {
            ...
            for (int i = 0; i < ToolEnvironment.BrushSizes.Length; ++i)
            {
                this.penSizeComboBox.Items.Add(ToolEnvironment.BrushSizes[i].ToString());
            }
            ...
            this.penSizeDecButton.Image = SciResources.SciResources.GetImageResource("Icons.MinusButtonIcon.png").Reference;
            this.penSizeIncButton.ToolTipText = "Larger Brush:";
            this.penSizeIncButton.Image = SciResources.SciResources.GetImageResource("Icons.PlusButtonIcon.png").Reference;
            ...
            this.gradientLinearClampedButton.Image = SciResources.SciResources.GetImageResource("Icons.LinearClampedGradientIcon.png").Reference;
            ...
            this.gradientLinearReflectedButton.Image = SciResources.SciResources.GetImageResource("Icons.LinearReflectedGradientIcon.png").Reference;
            this.gradientLinearDiamondButton.ToolTipText = this.gradientTypeNames.EnumValueToLocalizedName(GradientType.LinearDiamond);
            this.gradientLinearDiamondButton.Image = SciResources.SciResources.GetImageResource("Icons.LinearDiamondGradientIcon.png").Reference;
            this.gradientRadialButton.ToolTipText = this.gradientTypeNames.EnumValueToLocalizedName(GradientType.Radial);
            this.gradientRadialButton.Image = SciResources.SciResources.GetImageResource("Icons.RadialGradientIcon.png").Reference;
            this.gradientConicalButton.ToolTipText = this.gradientTypeNames.EnumValueToLocalizedName(GradientType.Conical);
            this.gradientConicalButton.Image = SciResources.SciResources.GetImageResource("Icons.ConicalGradientIcon.png").Reference;

            this.gradientAllColorChannelsImage = SciResources.SciResources.GetImageResource("Icons.AllColorChannelsIcon.png");
            this.gradientAlphaChannelOnlyImage = SciResources.SciResources.GetImageResource("Icons.AlphaChannelOnlyIcon.png");
            this.gradientChannelsSplitButton.Image = this.gradientAllColorChannelsImage.Reference;

            this.antiAliasingEnabledImage = SciResources.SciResources.GetImageResource("Icons.AntiAliasingEnabledIcon.png");
            this.antiAliasingDisabledImage = SciResources.SciResources.GetImageResource("Icons.AntiAliasingDisabledIcon.png");
            this.antiAliasingSplitButton.Image = this.antiAliasingEnabledImage.Reference;

            this.alphaBlendingEnabledImage = SciResources.SciResources.GetImageResource("Icons.BlendingEnabledIcon.png");
            this.alphaBlendingOverwriteImage = SciResources.SciResources.GetImageResource("Icons.BlendingOverwriteIcon.png");
            ...
            for (int i = 0; i < ToolEnvironment.DefaultFontSizes.Length; ++i)
            {
                this.fontSizeComboBox.Items.Add(ToolEnvironment.DefaultFontSizes[i].ToString());
            }
            ...
            try
            {
                this.arialFontBase = new Font(arialFontFamily, ToolEnvironment.InitialFontSize, FontStyle.Regular);
            }

            catch (Exception)
            {
                this.arialFontBase = new Font(FontFamily.GenericSansSerif, ToolEnvironment.InitialFontSize, FontStyle.Regular);
            }
            ...
            this.oldSizeValue = ToolEnvironment.InitialFontSize;
            ...
            this.fontBoldButton.Image = SciResources.SciResources.GetImageBmpOrPng("Icons.FontBoldIcon");
            this.fontItalicsButton.Image = SciResources.SciResources.GetImageBmpOrPng("Icons.FontItalicIcon");
            this.fontUnderlineButton.Image = SciResources.SciResources.GetImageBmpOrPng("Icons.FontUnderlineIcon");

            this.fontAlignLeftButton.Image = SciResources.SciResources.GetImageResource("Icons.TextAlignLeftIcon.png").Reference;
            this.fontAlignCenterButton.Image = SciResources.SciResources.GetImageResource("Icons.TextAlignCenterIcon.png").Reference;
            this.fontAlignRightButton.Image = SciResources.SciResources.GetImageResource("Icons.TextAlignRightIcon.png").Reference;
            ...
            this.selectionDrawModeSwapButton.Image = SciResources.SciResources.GetImageResource("Icons.ToolConfigStrip.SelectionDrawModeSwapButton.png").Reference;
        ...
        private void InitializeComponent()
        {
            ...
            this.penSizeDecButton.Click +=
                delegate (object sender, EventArgs e)
                {
                    ...
                    ToolEnvironment.Environment.AddToPenSize(amount);
                };
            //
            // penSizeComboBox
            //
            ...
            this.fontSizeComboBox.Text = ToolEnvironment.InitialFontSize.ToString();
        ...
        private ImageResource shapeOutlineImage = SciResources.SciResources.GetImageResource("Icons.ShapeOutlineIcon.png");
        private ImageResource shapeInteriorImage = SciResources.SciResources.GetImageResource("Icons.ShapeInteriorIcon.png");
        private ImageResource shapeBothImage = SciResources.SciResources.GetImageResource("Icons.ShapeBothIcon.png");
        ...
        private EnumLocalizer lineCapLocalizer = EnumLocalizer.Create(typeof(PenInfo.LineCap2));
        ...
        private PenInfo.LineCap2[] lineCaps =
            new PenInfo.LineCap2[]
            {
                PenInfo.LineCap2.Flat,
                PenInfo.LineCap2.Arrow,
                PenInfo.LineCap2.ArrowFilled,
                PenInfo.LineCap2.Rounded
            };
        ...
        #region Message from ToolEnvironment
        public void LoadFromToolEnvironment(ToolEnvironment ToolEnvironment)
        {
            ToolEnvironment.AlphaBlendingChanged += ToolEnvironment_AlphaBlendingChanged;
            AlphaBlending = ToolEnvironment.AlphaBlending;

            ToolEnvironment.AntiAliasingChanged += ToolEnvironment_AntiAliasingChanged;
            AntiAliasing = ToolEnvironment.AntiAliasing;

            ToolEnvironment.BrushInfoChanged += ToolEnvironment_BrushInfoChanged;
            BrushInfo = ToolEnvironment.BrushInfo;

            ToolEnvironment.ColorPickerClickBehaviorChanged += ToolEnvironment_ColorPickerClickBehaviorChanged;
            ColorPickerClickBehavior = ToolEnvironment.ColorPickerClickBehavior;

            ToolEnvironment.GradientInfoChanged += ToolEnvironment_GradientInfoChanged;
            GradientInfo = ToolEnvironment.GradientInfo;

            ToolEnvironment.PenInfoChanged += ToolEnvironment_PenInfoChanged;
            PenInfo = ToolEnvironment.PenInfo;

            ToolEnvironment.ResamplingAlgorithmChanged += ToolEnvironment_ResamplingAlgorithmChanged;
            ResamplingAlgorithm = ToolEnvironment.ResamplingAlgorithm;

            ToolEnvironment.ShapeDrawTypeChanged += ToolEnvironment_ShapeDrawTypeChanged;
            ShapeDrawType = ToolEnvironment.ShapeDrawType;

            ToolEnvironment.FontInfoChanged += ToolEnvironment_FontInfoChanged;
            FontInfo = ToolEnvironment.FontInfo;

            ToolEnvironment.FontSmoothingChanged += ToolEnvironment_FontSmoothingChanged;
            FontSmoothing = ToolEnvironment.FontSmoothing;


            FontAlignment = ToolEnvironment.TextAlignment;

            ToolEnvironment.ToleranceChanged += ToolEnvironment_ToleranceChanged;
            Tolerance = ToolEnvironment.Tolerance;

            ToolEnvironment.SelectionCombineModeChanged += ToolEnvironment_SelectionCombineModeChanged;
            SelectionCombineMode = ToolEnvironment.SelectionCombineMode;

            ToolEnvironment.FloodModeChanged += ToolEnvironment_FloodModeChanged;
            FloodMode = ToolEnvironment.FloodMode;

            ToolEnvironment.SelectionDrawModeInfoChanged += ToolEnvironment_SelectionDrawModeInfoChanged;
            SelectionDrawModeInfo = ToolEnvironment.SelectionDrawModeInfo;
        }

        private void ToolEnvironment_GradientInfoChanged(object sender, EventArgs e)
        {
            if (GradientInfo != ((ToolEnvironment)sender).GradientInfo)
                GradientInfo = ((ToolEnvironment)sender).GradientInfo;
        }

        private void ToolEnvironment_PenInfoChanged(object sender, EventArgs e)
        {
            if (PenInfo != ((ToolEnvironment)sender).PenInfo)
                PenInfo = ((ToolEnvironment)sender).PenInfo;
        }

        private void ToolEnvironment_ResamplingAlgorithmChanged(object sender, EventArgs e)
        {
            if (ResamplingAlgorithm != ((ToolEnvironment)sender).ResamplingAlgorithm)
                ResamplingAlgorithm = ((ToolEnvironment)sender).ResamplingAlgorithm;
        }

        private void ToolEnvironment_ShapeDrawTypeChanged(object sender, EventArgs e)
        {
            if (ShapeDrawType != ((ToolEnvironment)sender).ShapeDrawType)
                ShapeDrawType = ((ToolEnvironment)sender).ShapeDrawType;
        }

        private void ToolEnvironment_FontInfoChanged(object sender, EventArgs e)
        {
            if (FontInfo != ((ToolEnvironment)sender).FontInfo)
                FontInfo = ((ToolEnvironment)sender).FontInfo;
        }

        private void ToolEnvironment_FontSmoothingChanged(object sender, EventArgs e)
        {
            if (FontSmoothing != ((ToolEnvironment)sender).FontSmoothing)
                FontSmoothing = ((ToolEnvironment)sender).FontSmoothing;
        }

        private void ToolEnvironment_ToleranceChanged(object sender, EventArgs e)
        {
            if (Tolerance != ((ToolEnvironment)sender).Tolerance)
                Tolerance = ((ToolEnvironment)sender).Tolerance;
        }

        private void ToolEnvironment_SelectionCombineModeChanged(object sender, EventArgs e)
        {
            if (SelectionCombineMode != ((ToolEnvironment)sender).SelectionCombineMode)
                SelectionCombineMode = ((ToolEnvironment)sender).SelectionCombineMode;
        }

        private void ToolEnvironment_FloodModeChanged(object sender, EventArgs e)
        {
            if (FloodMode != ((ToolEnvironment)sender).FloodMode)
                FloodMode = ((ToolEnvironment)sender).FloodMode;
        }

        private void ToolEnvironment_SelectionDrawModeInfoChanged(object sender, EventArgs e)
        {
            if (SelectionDrawModeInfo != ((ToolEnvironment)sender).SelectionDrawModeInfo)
                SelectionDrawModeInfo = ((ToolEnvironment)sender).SelectionDrawModeInfo;
        }

        private void ToolEnvironment_ColorPickerClickBehaviorChanged(object sender, EventArgs e)
        {
            if (ColorPickerClickBehavior != ((ToolEnvironment)sender).ColorPickerClickBehavior)
                ColorPickerClickBehavior = ((ToolEnvironment)sender).ColorPickerClickBehavior;
        }

        private void ToolEnvironment_BrushInfoChanged(object sender, EventArgs e)
        {
            if (BrushInfo != ((ToolEnvironment)sender).BrushInfo)
                BrushInfo = ((ToolEnvironment)sender).BrushInfo;
        }

        private void ToolEnvironment_AntiAliasingChanged(object sender, EventArgs e)
        {
            if (AntiAliasing != ((ToolEnvironment)sender).AntiAliasing)
                AntiAliasing = ((ToolEnvironment)sender).AntiAliasing;
        }

        private void ToolEnvironment_AlphaBlendingChanged(object sender, EventArgs e)
        {
            if (AlphaBlending != ((ToolEnvironment)sender).AlphaBlending)
                AlphaBlending = ((ToolEnvironment)sender).AlphaBlending;
        }
        #endregion
        ...
        {
            if (ToolEnvironment.Environment.BrushInfo != BrushInfo)
                ToolEnvironment.Environment.BrushInfo = BrushInfo;
        }
        ...
        private void BrushSizeComboBox_Validating(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            if (!valid)
            {
                ...
                this.penSizeComboBox.ToolTipText = SciResources.SciResources.GetString("PenConfigWidget.Error.InvalidNumber");
            }
            else
            {
                if (penSize < ToolEnvironment.MinPenSize)
                {
                    // Set the error if the size is too small.
                    this.penSizeComboBox.BackColor = Color.Red;
                    string tooSmallFormat = SciResources.SciResources.GetString("PenConfigWidget.Error.TooSmall.Format");
                    string tooSmall = string.Format(tooSmallFormat, ToolEnvironment.MinPenSize);
                    this.penSizeComboBox.ToolTipText = tooSmall;
                }
                else if (penSize > ToolEnvironment.MaxPenSize)
                {
                    // Set the error if the size is too large.
                    this.penSizeComboBox.BackColor = Color.Red;
                    string tooLargeFormat = SciResources.SciResources.GetString("PenConfigWidget.Error.TooLarge.Format");
                    string tooLarge = string.Format(tooLargeFormat, ToolEnvironment.MaxPenSize);
        ...
        protected void OnGradientInfoChanged()
        {
            if (ToolEnvironment.Environment.GradientInfo != this.GradientInfo)
                ToolEnvironment.Environment.GradientInfo = this.GradientInfo;
        }
        ...
        private void GradientChannelsSplitButton_DropDownOpening(object sender, EventArgs e)
        {
            ToolStripMenuItem allChannels = new ToolStripMenuItem(
                SciResources.SciResources.GetString("GradientChannels.AllColorChannels.Text"),
            ...
            ToolStripMenuItem alphaOnly = new ToolStripMenuItem(
                SciResources.SciResources.GetString("GradientChannels.AlphaChannelOnly.Text"),
        ...
        {
            if (ToolEnvironment.Environment.ShapeDrawType != this.ShapeDrawType)
                ToolEnvironment.Environment.ShapeDrawType = this.ShapeDrawType;
        ...
        private void ShapeButton_DropDownOpening(object sender, EventArgs e)
        {
            ...
            outlineMI.Text = SciResources.SciResources.GetString("ShapeDrawTypeConfigWidget.OutlineButton.ToolTipText");
            ...
            interiorMI.Text = SciResources.SciResources.GetString("ShapeDrawTypeConfigWidget.InteriorButton.ToolTipText");
            ...
            bothMI.Text = SciResources.SciResources.GetString("ShapeDrawTypeConfigWidget.BothButton.ToolTipText");
        ...
        {
            if (ToolEnvironment.Environment.FontInfo != this.FontInfo)
                ToolEnvironment.Environment.FontInfo = this.FontInfo;
        }

        protected virtual void OnTextAlignmentChanged()
        {
            if (ToolEnvironment.Environment.TextAlignment != this.FontAlignment)
                ToolEnvironment.Environment.TextAlignment = this.FontAlignment;
          
        }

        protected virtual void OnFontSmoothingChanged()
        {
            if (ToolEnvironment.Environment.FontSmoothing != this.FontSmoothing)
                ToolEnvironment.Environment.FontSmoothing = this.FontSmoothing;
        ...
        private void FontFamilyComboBox_DrawItem(object sender, System.Windows.Forms.DrawItemEventArgs e)
        {
            if (e.Index != -1)
            {
                ...
                using (Font myFont = IndexToFont(e.Index, 10, FontStyle.Regular))
                {
                    ...
                    bool isSymbol = Fonts.IsSymbolFont(myFont);
        ...
        private void FontSizeComboBox_Validating(object sender, System.ComponentModel.CancelEventArgs e)
        {
            try
            {
                ...
                if (invalid)
                {
                    ...
                    this.fontSizeComboBox.ToolTipText = SciResources.SciResources.GetString("TextConfigWidget.Error.InvalidNumber");
                }
                else
                {
                    if ((float.Parse(fontSizeComboBox.Text) <ToolEnvironment.MinFontSize))
                    {
                        // Set the error if the size is too small.
                        this.fontSizeComboBox.BackColor = Color.Red;
                        string format = SciResources.SciResources.GetString("TextConfigWidget.Error.TooSmall.Format");
                        string text = string.Format(format, ToolEnvironment.MinFontSize);
                        this.fontSizeComboBox.ToolTipText = text;
                    }
                    else if ((float.Parse(fontSizeComboBox.Text) > ToolEnvironment.MaxFontSize))
                    {
                        // Set the error if the size is too large.
                        this.fontSizeComboBox.BackColor = Color.Red;
                        string format = SciResources.SciResources.GetString("TextConfigWidget.Error.TooLarge.Format");
                        string text = string.Format(format, ToolEnvironment.MaxFontSize);
                        this.fontSizeComboBox.ToolTipText = text;
                    }
                    else
                    {
        ...
        private PenInfo.LineCap2 NextLineCap(PenInfo.LineCap2 oldCap)
        {
            int capIndex = Array.IndexOf<PenInfo.LineCap2>(this.lineCaps, oldCap);
        ...
        protected void OnPenChanged()
        {
            try
            {
                ...
                {
                    if (ToolEnvironment.Environment.PenInfo != this.PenInfo)
                        ToolEnvironment.Environment.PenInfo = this.PenInfo;
                }
            }
            catch { }
        }
        ...
        public PenInfo PenInfo
        {
            get
            {
                ...
                PenInfo.LineCap2 startCap;

                try
                {
                    startCap = (PenInfo.LineCap2)this.penStartCapSplitButton.Tag;
                }
                ...
                PenInfo.LineCap2 endCap;

                try
                {
                    endCap = (PenInfo.LineCap2)this.penEndCapSplitButton.Tag;
                }
        ...
        private Image GetDashStyleImage(DashStyle dashStyle)
        {
            ...
            ImageResource imageResource = SciResources.SciResources.GetImageResource(name);
        ...
        private ImageResource GetLineCapImage(PenInfo.LineCap2 lineCap, bool isStartCap)
        {
        ...
        private void PenCapSplitButton_DropDownOpening(object sender, EventArgs e)
        {
            ...
            PenInfo.LineCap2 currentLineCap = PenInfo.DefaultLineCap;
            bool isStartCap;
            ...
            foreach (PenInfo.LineCap2 lineCap in this.lineCaps)
            {
                ToolStripMenuItem mi = new ToolStripMenuItem(
                    ...
                    {
                        ToolStripMenuItem tsmi = (ToolStripMenuItem)sender2;
                        Pair<ToolStripSplitButton, PenInfo.LineCap2> data = (Pair<ToolStripSplitButton, PenInfo.LineCap2>)tsmi.Tag;
        ...
        {
            if (ToolEnvironment.Environment.AlphaBlending != this.AlphaBlending)
                ToolEnvironment.Environment.AlphaBlending = this.AlphaBlending;
        ...
        private void AlphaBlendingSplitButton_DropDownOpening(object sender, EventArgs e)
        {
            ToolStripMenuItem abEnabled = new ToolStripMenuItem(
                SciResources.SciResources.GetString("AlphaBlendingSplitButton.BlendingEnabled.Text"),
            ...
            ToolStripMenuItem abOverwrite = new ToolStripMenuItem(
                SciResources.SciResources.GetString("AlphaBlendingSplitButton.BlendingOverwrite.Text"),
        ...
        private void AntiAliasingSplitButton_DropDownOpening(object sender, EventArgs e)
        {
            ToolStripMenuItem aaEnabled = new ToolStripMenuItem(
                SciResources.SciResources.GetString("AntiAliasingSplitButton.Enabled.Text"),
            ...
            ToolStripMenuItem aaDisabled = new ToolStripMenuItem(
                SciResources.SciResources.GetString("AntiAliasingSplitButton.Disabled.Text"),
        ...
        {
            if (ToolEnvironment.Environment.AntiAliasing != this.AntiAliasing)
                ToolEnvironment.Environment.AntiAliasing = this.AntiAliasing;
        ...
        {
            if (ToolEnvironment.Environment.Tolerance != this.Tolerance)
                ToolEnvironment.Environment.Tolerance = this.Tolerance;
        }
        ...
        {
            if (ToolEnvironment.Environment.ColorPickerClickBehavior != this.ColorPickerClickBehavior)
                ToolEnvironment.Environment.ColorPickerClickBehavior = this.ColorPickerClickBehavior;
        ...
        {
            if (ToolEnvironment.Environment.ResamplingAlgorithm != this.ResamplingAlgorithm)
                ToolEnvironment.Environment.ResamplingAlgorithm = this.ResamplingAlgorithm;
        ...
        {
            if (ToolEnvironment.Environment.SelectionCombineMode != this.SelectionCombineMode)
                ToolEnvironment.Environment.SelectionCombineMode = this.SelectionCombineMode;
        ...
        {
            return SciResources.SciResources.GetImageResource("Icons.ToolConfigStrip.SelectionCombineMode." + cm.ToString() + ".png");
        }
        ...
        private void SelectionCombineModeSplitButton_DropDownOpening(object sender, EventArgs e)
        {
                ...
                })
            {
                ToolStripMenuItem cmMI = new ToolStripMenuItem(
                    SciResources.SciResources.GetString("ToolConfigStrip.SelectionCombineModeSplitButton." + cm.ToString() + ".Text"),
        ...
        {
            if (ToolEnvironment.Environment.FloodMode != this.FloodMode)
                ToolEnvironment.Environment.FloodMode = this.FloodMode;
        }
        ...
        {
            return SciResources.SciResources.GetImageResource("Icons.ToolConfigStrip.FloodMode." + cm.ToString() + ".png");
        }
        ...
        private void FloodModeSplitButton_DropDownOpening(object sender, EventArgs e)
        {
                ...
                })
            {
                ToolStripMenuItem fmMI = new ToolStripMenuItem(
                    SciResources.SciResources.GetString("ToolConfigStrip.FloodModeSplitButton." + fm.ToString() + ".Text"),
        ...
        {
            //if (ToolEnvironment.Environment.draw != this.FloodMode)
            //    ToolEnvironment.Environment.FloodMode = this.FloodMode;
        ...
        {
            //if (ToolEnvironment.Environment.SelectionDrawModeInfo != this.FloodMode)
            //    ToolEnvironment.Environment.FloodMode = this.FloodMode;
        ...
        {
            if (ToolEnvironment.Environment.SelectionDrawModeInfo != this.SelectionDrawModeInfo)
                ToolEnvironment.Environment.SelectionDrawModeInfo = this.SelectionDrawModeInfo;
        }
        ...
        {
            return SciResources.SciResources.GetString("ToolConfigStrip.SelectionDrawModeSplitButton." + drawMode.ToString() + ".Text");
        }

        private Image GetSelectionDrawModeImage(SelectionDrawMode drawMode)
        {
            return SciResources.SciResources.GetImageResource("Icons.ToolConfigStrip.SelectionDrawModeSplitButton." + drawMode.ToString() + ".png").Reference;
        }
        ...
        //            AppEnvironment.Environment.ToolBar.ToolConfigStrip, ActiveDocumentWorkspace.Document);
