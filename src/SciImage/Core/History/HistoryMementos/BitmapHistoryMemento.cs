...
namespace SciImage.Core.History.HistoryMementos
{
        ...
        : HistoryMemento
    {
            ...
            : HistoryMementoData
        {
            ...
            public BitmapHistoryMementoData(IrregularSurface undoImage, SciRegion savedRegion)
            {
        ...
        private static unsafe void LoadOrSaveSurfaceRegion(FileStream fileHandle, Surface surface, SciRegion region, bool trueForSave)
        {
        ...
        private static unsafe void SaveSurfaceRegion(FileStream outputHandle, Surface surface, SciRegion region)
        {
            LoadOrSaveSurfaceRegion(outputHandle, surface, region, true);
        }

        private static unsafe void LoadSurfaceRegion(FileStream inputHandle, Surface surface, SciRegion region)
        {
        ...
        public BitmapHistoryMemento(string name, ImageResource image, IHistoryWorkspace historyWorkspace, 
            int layerIndex, SciRegion changedRegion)
        ...
        public BitmapHistoryMemento(string name, ImageResource image, IHistoryWorkspace historyWorkspace, 
            int layerIndex, SciRegion changedRegion, Surface copyFromThisSurface)
            : base(name, image)
        {
            this.historyWorkspace = historyWorkspace;
            this.layerIndex = layerIndex;

            SciRegion region = changedRegion.Clone();
        ...
        protected override HistoryMemento OnUndo()
        {
            ...
            SciRegion simplified = Utility.SimplifyAndInflateRegion(region);
