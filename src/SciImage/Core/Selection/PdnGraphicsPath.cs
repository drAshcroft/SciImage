...
{ 
    ...
    { 
        ...
        public SciRegion regionCache = null;
        ...
        public SciRegion GetRegionCache()
        {
            if (regionCache == null)
            {
                regionCache = new SciRegion(this.gdiPath);
            }
        ...
        public static PdnGraphicsPath FromRegion(SciRegion region)
        {
        ...
        public static PdnGraphicsPath FromRegions(SciRegion lhs, CombineMode combineMode, SciRegion rhs)
        {
