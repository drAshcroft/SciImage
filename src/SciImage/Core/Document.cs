...
namespace SciImage.Core
{
          ...
          ICloneable
    {
        ...
        public void Render(RenderArgs args, Rectangle roi, bool clearBackground)
        {
            ...
            if (clearBackground)
            {
                ...
                if (layer0 != null && 
                    layer0.Visible && 
                    layer0.Opacity == 255 &&
                    layer0.BlendOp.GetType() == UserBlendOpsMaster.GetDefaultBlendOp())
                {
        ...
        public bool Update(RenderArgs dst)
        {
            ...
            SciRegion region = Utility.RectanglesToRegion(updateRects, 0, updateRectsLength);
        ...
        public void Invalidate(SciRegion roi)
        {
            Dirty = true;
        ...
        public static Document FromStream(Stream stream)
        {
            ...
            sfb.AddAssembly(typeof(Memory).Assembly); // third, try SciImage.SystemLayer.dll
        ...
        public void SaveToStream(Stream stream, IOEventHandler callback)
        {
            ...
            // Copy version info
            this.savedWith = SciInfo.GetVersion();
