    ...
    public sealed class Utility
    {
        ...
        public static string WebExceptionToErrorMessage(WebException wex)
        {
            ...
            switch (wex.Status)
            {
                case WebExceptionStatus.ProtocolError:
                    string format = SciResources.SciResources.GetString("WebExceptionStatus.ProtocolError.Format");
                ...
                default:
                    ...
                    errorMessage = SciResources.SciResources.GetString(stringName);
                    break;
            }
        ...
        public static string SizeStringFromBytes(long bytes)
        {
            ...
            if (bytesDouble > (1024 * 1024 * 1024))
            {
                ...
                toStringFormat = "F1";
                formatString = SciResources.SciResources.GetString("Utility.SizeStringFromBytes.GBFormat");
            }
            ...
            else if (bytesDouble > (1024))
            {
                ...
                bytesDouble /= 1024;
                toStringFormat = "F1";
                formatString = SciResources.SciResources.GetString("Utility.SizeStringFromBytes.KBFormat");
            }
            else
            {
                // Bytes
        ...
        public static void ShowWiaError(IWin32Window owner)
        {
            ...
            {
                Utility.ErrorBox(owner, SciResources.SciResources.GetString("WIA.Error.EnableMe"));
            }
            else
            {
                Utility.ErrorBox(owner, SciResources.SciResources.GetString("WIA.Error.UnableToLoad"));
            }
        }

        public static void ShowNonAdminErrorBox(IWin32Window parent)
        {
            ErrorBox(parent, SciResources.SciResources.GetString("NonAdminErrorBox.Message"));
        }

        public static void ErrorBox(IWin32Window parent, string message)
        {
            MessageBox.Show(parent, message, SciInfo.GetBareProductName(), MessageBoxButtons.OK, MessageBoxIcon.Error);
        }

        public static DialogResult ErrorBoxOKCancel(IWin32Window parent, string message)
        {
            return MessageBox.Show(parent, message, SciInfo.GetBareProductName(), MessageBoxButtons.OKCancel, MessageBoxIcon.Error);
        }

        public static void InfoBox(IWin32Window parent, string message)
        {
            MessageBox.Show(parent, message, SciInfo.GetBareProductName(), MessageBoxButtons.OK, MessageBoxIcon.Information);
        }

        public static DialogResult InfoBoxOKCancel(IWin32Window parent, string message)
        {
            return MessageBox.Show(parent, message, SciInfo.GetBareProductName(), MessageBoxButtons.OKCancel, MessageBoxIcon.Information);
        }

        public static DialogResult AskOKCancel(IWin32Window parent, string question)
        {
            return MessageBox.Show(parent, question, SciInfo.GetBareProductName(), MessageBoxButtons.OKCancel, MessageBoxIcon.Question);
        }

        public static DialogResult AskYesNo(IWin32Window parent, string question)
        {
            return MessageBox.Show(parent, question, SciInfo.GetBareProductName(), MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        }

        public static DialogResult AskYesNoCancel(IWin32Window parent, string question)
        {
            return MessageBox.Show(parent, question, SciInfo.GetBareProductName(), MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
        }
        ...
        /// <returns></returns>
        public static SciRegion RectanglesToRegion(RectangleF[] rectsF, int startIndex, int length)
        {
            SciRegion region;

            if (rectsF == null || rectsF.Length == 0 || length == 0)
            {
                region = SciRegion.CreateEmpty();
            }
            else
            {
        ...
        public static SciRegion RectanglesToRegion(RectangleF[] rectsF)
        {
            return RectanglesToRegion(rectsF, 0, rectsF != null ? rectsF.Length : 0);
        }

        public static SciRegion RectanglesToRegion(RectangleF[] rectsF1, RectangleF[] rectsF2, params RectangleF[][] rectsFA)
        {
            using (PdnGraphicsPath path = new PdnGraphicsPath())
            {
                path.FillMode = FillMode.Winding;
                ...
                return new SciRegion(path);
            }
        }

        public static SciRegion RectanglesToRegion(Rectangle[] rects, int startIndex, int length)
        {
            SciRegion region;
        ...
        public static SciRegion RectanglesToRegion(Rectangle[] rects)
        {
        ...
        public static Rectangle GetRegionBounds(SciRegion region)
        {
        ...
        /// <returns></returns>
        public static Rectangle[] SimplifyRegion(SciRegion region, int complexity)
        {
            Rectangle[] rects = region.GetRegionScansReadOnlyInt();
        ...
        public static SciRegion SimplifyAndInflateRegion(SciRegion region, int complexity, int inflationAmount)
        {
        ...
        public static SciRegion SimplifyAndInflateRegion(SciRegion region)
        {
        ...
        public static DialogResult ShowDialog(IEffectConfigDialog showMe2, IWin32Window owner)
        {
        ...
        public static DialogResult ShowDialog(Form showMe, IWin32Window owner)
        {
            ...
            if (showMe is SciBaseForm)
            {
                SciBaseForm showMe2 = (SciBaseForm)showMe;
        ...
        {
            string helpFileUrlFormat = SciResources.SciResources.GetString("HelpFile.Url.Format");
            string baseSiteUrl = InvariantStrings.WebsiteUrl;
            string helpFileUrl = string.Format(helpFileUrlFormat, baseSiteUrl);
            SciInfo.OpenUrl(parent, helpFileUrl);
        }
