...
namespace SciImage.Core.Surfaces
{
          ...
          IDeserializationCallback
    {
        ...
        private SciRegion GetRegion()
        {
            if (this.region == null)
            {
                this.region = new SciRegion(this.shadowPath);
            }

            return this.region;
        }

        public SciRegion CreateRegion()
        {
            if (this.disposed)
            {
        ...
        public MaskedSurface(Surface source, SciRegion roi)
        {
            SciRegion roiClipped = (SciRegion)roi.Clone();
        ...
        public MaskedSurface(Surface source, PdnGraphicsPath path)
        {
            ...
            {
                SciRegion region = new SciRegion(path);
            ...
            else
            {
                ...
                this.region = new SciRegion(this.path);
