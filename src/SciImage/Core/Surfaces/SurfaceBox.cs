...
namespace SciImage.Core.Surfaces
{
        ...
        : Control
    {
        ...
        private static SystemLayer.Base.WeakReference<Surface> doubleBufferSurfaceWeakRef = null;
        ...
        private Surface GetDoubleBuffer(Size size)
        {
            ...
            if (localDBSurface == null)
            {
                ...
                doubleBufferSurfaceWeakRef = new SystemLayer.Base.WeakReference<Surface>(localDBSurface);
            }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            if (this.surface != null)
            {
                SciRegion clipRegion = null;
                Rectangle[] rects = this.realUpdateRects;

                if (rects == null)
                {
                    clipRegion = new SciRegion(e.Graphics.Clip, true);
               ...
               // PdnGraphics.FillRectangles(e.Graphics, Color.Red, rects);
                if (clipRegion != null)
                {
                    clipRegion.Dispose();
                    clipRegion = null;
