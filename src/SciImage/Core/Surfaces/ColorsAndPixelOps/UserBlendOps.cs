...
namespace SciImage.Core.Surfaces.ColorsAndPixelOps
{
    /// <summary>
    ...
    /// </summary>
    public sealed  class UserBlendOpsMaster
    {
        private UserBlendOpsMaster()
        {
        }
        ...
        {
            Type[] allTypes = typeof(UserBlendOpsMaster).GetNestedTypes();
