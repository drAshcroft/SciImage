...
using SciImage.SystemLayer.StylusReader;

namespace SciImage.SystemLayer.System
{
    public static class Ink
    {
            ...
            : IStylusReaderHooks
        {
            ...
            public global::System.Drawing.Graphics CreateGraphics()
            {
                return subject.CreateGraphics();
            }

            public void PerformDocumentMouseMove(global::System.Windows.Forms.MouseButtons button, int clicks, float x, float y, int delta, float pressure)
            {
                subject.PerformDocumentMouseMove(button, clicks, x, y, delta, pressure);
            }

            public global::System.Drawing.PointF ScreenToDocument(global::System.Drawing.PointF pointF)
            {
                return subject.ScreenToDocument(pointF);
            }

            public void PerformDocumentMouseUp(global::System.Windows.Forms.MouseButtons button, int clicks, float x, float y, int delta, float pressure)
            {
                subject.PerformDocumentMouseUp(button, clicks, x, y, delta, pressure);
            }

            public void PerformDocumentMouseDown(global::System.Windows.Forms.MouseButtons button, int clicks, float x, float y, int delta, float pressure)
            {
        ...
        private static void HookInkImpl(IInkHooks subject, Control control)
        {
            ...
            StylusReader.StylusReader.HookStylus(adapter, control);
        }
        ...
        {
            StylusReader.StylusReader.UnhookStylus(control);
        }
