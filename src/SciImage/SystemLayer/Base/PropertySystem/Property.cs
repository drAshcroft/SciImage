...
namespace SciImage.SystemLayer.Base.PropertySystem
{
                ...
                else
                {
                    switch (this.vvfResult)
                    {
                        ...
                        case ValueValidationFailureResult.Ignore:
                            global::System.Diagnostics.Debug.WriteLine(string.Format("{0} is not a valid value for {1}", value2.ToString(), this.name));
                            OnValueChanged();
                            break;
