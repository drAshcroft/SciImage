...
namespace SciImage.SystemLayer.Fonts
{
    /// <summary>
    ...
    public static class Fonts
    {
        ...
        public static Size MeasureString(global::System.Drawing.Graphics g, Font font, string text, bool antiAliasing, FontSmoothing fontSmoothing)
        {
        ...
        /// <param name="antiAliasing">Whether the font should be rendered with anti-aliasing.</param>
        public static void DrawText(global::System.Drawing.Graphics g, Font font, string text, Point pt, bool antiAliasing, FontSmoothing fontSmoothing)
        {
            if (fontSmoothing == FontSmoothing.Smooth && antiAliasing)
            {
                PixelOffsetMode oldPOM = g.PixelOffsetMode;
