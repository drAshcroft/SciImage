...
using SciImage.SystemLayer.Native;
using SciImage.SystemLayer.System;

namespace SciImage.SystemLayer.Graphics
{
    /// <summary>
    ...
    public static class PdnGraphics
    {
        ...
        public unsafe static void DrawBitmap(
            global::System.Drawing.Graphics dst,
            Rectangle dstRect,
            Matrix dstMatrix,
        ...
        /// </remarks>
        public static void DrawPolyLine(global::System.Drawing.Graphics g, Color color, Point[] points)
        {
            try
            {
        ...
        private static void DrawPolyLineImpl(global::System.Drawing.Graphics g, Color color, Point[] points)
        {
            if (points.Length < 1)
            {
                return;
        ...
        /// </remarks>
        public static void FillRectangles(global::System.Drawing.Graphics g, Color color, Rectangle[] rects)
        {
            try
            {
        ...
        private static void FillRectanglesImpl(global::System.Drawing.Graphics g, Color color, Rectangle[] rects)
        {
            uint nativeColor = (uint)(color.R  + (color.G << 8) + (color.B << 16));
