        ...
        : Control
    {
        ...
        private void BannerTimer_Tick(object sender, EventArgs e)
        {
                ...
                findForm.WindowState != FormWindowState.Minimized)
            {
                ...
                if (banners.Length < 2 || UserSessions.IsRemote)
                {
                    newBannerAlpha = 1.0f;
                }
        ...
        private Image pdnLogo = SciResources.SciResources.GetImageResource("Images.TransparentLogo.png").GetCopy();
        ...
        private Image[] banners = new Image[]
            {
                SciResources.SciResources.GetImageResource("Images.Banner.png").GetCopy(),
            };
