...
namespace SciImage.PaintForms.UserControls.Widgets
{
        ...
        : UserControl
    {
        ...
        public PanControl()
        {
            if (!this.DesignMode)
            {
                handCursor = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.PanToolCursor.cur"));
                handMouseDownCursor = new Cursor(SciResources.SciResources.GetResourceStream("Cursors.PanToolCursorMouseDown.cur"));
