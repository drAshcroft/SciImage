...
namespace SciImage.PaintForms.UserControls.Documents
{
    /// <summary>
    ...
    public class DocumentView
        : UserControl, IInkHooks, IUserControl2
    {
        /// <summary>
        ...
        protected void RenderCompositionTo(Surface dst, bool highQuality, bool forceUpToDate)
        {
                ...
                dst.Height == this.compositionSurface.Height)
            {
                ...
                new NormalBlendOp().Apply(dst, this.compositionSurface);
            }
            else if (highQuality)
            {
                ...
                new NormalBlendOp().Apply(dst, thumb);
        ...
        public MeasurementUnit Units
        {
            ...
            set
            {
                if (this.leftRuler.MeasurementUnit != value)
                {
        ...
        private void DocumentView_UnitsChanged(object sender, EventArgs e)
        {
            Units = ((AppEnvironment)sender).Units;
        }
        protected void OnUnitsChanged()
        {
            AppEnvironment.Environment.Units = Units;
        }
        ...
        {
            this.gridRenderer.Visible = ((AppEnvironment)sender).DrawGrid;
        }
        protected virtual void OnDrawGridChanged()
        {
            AppEnvironment.Environment.DrawGrid = DrawGrid;
        }
        ...
        {
            if (AppEnvironment.Environment.RulersEnabled != RulersEnabled)
                AppEnvironment.Environment.RulersEnabled = RulersEnabled;
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.surfaceBox.PrePaint += new PaintEventHandler2(this.SurfaceBox_PrePaint);
            this.surfaceBox.BackColor = Color.Red;
        ...
        public DocumentView()
        {
            ...
            AppEnvironment.Environment.DrawGridChanged += DocumentView_DrawGridChanged;
            AppEnvironment.Environment.UnitsChanged += DocumentView_UnitsChanged;
            AppEnvironment.Environment.RulersEnabledChanged += DocumentView_RulersEnabledChanged;
        }
        ...
        #region Document Mouse Controls
