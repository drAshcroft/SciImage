...
namespace SciImage.PaintForms.UserControls.ColorPickers
{
        ...
        : SciBaseForm
    {
        ...
        {
            this.Text = SciResources.SciResources.GetString("SavePaletteDialog.Text");
            this.Icon = Utility.ImageToIcon(SciResources.SciResources.GetImageResource("Icons.MenuFileSaveAsIcon.png").Reference);
            this.cancelButton.Text = "Cancel";
            this.saveButton.Text = SciResources.SciResources.GetString("Form.SaveButton.Text");
            this.typeANameLabel.Text = SciResources.SciResources.GetString("SavePaletteDialog.TypeANameLabel.Text");
            this.palettesLabel.Text = SciResources.SciResources.GetString("SavePaletteDialog.PalettesLabel.Text");
            base.LoadResources();
        }
