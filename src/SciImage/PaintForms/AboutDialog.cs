...
namespace SciImage.PaintForms
{
        ...
        : SciBaseForm
    {
        ...
        public AboutDialog()
        {
            ...
            string textFormat = SciResources.SciResources.GetString("AboutDialog.Text.Format");
            this.Text = string.Format(textFormat, SciInfo.GetBareProductName());

            this.sciBanner.BannerText = string.Empty;// PdnInfo.GetFriendlyVersionString();
            this.richCreditsBox.LoadFile(SciResources.SciResources.GetResourceStream("Files.AboutCredits.rtf"), RichTextBoxStreamType.RichText);
            this.copyrightLabel.Text = SciInfo.GetCopyrightString();

            this.Icon = SciInfo.AppIcon;

            this.okButton.Text = "OK";
            this.okButton.Location = new Point((this.ClientSize.Width - this.okButton.Width) / 2, this.okButton.Top);

            this.creditsLabel.Text = SciResources.SciResources.GetString("AboutDialog.CreditsLabel.Text");

            Font bannerFont = this.sciBanner.BannerFont;
            Font newBannerFont = Utility.CreateFont(bannerFont.Name, 8.0f, bannerFont.Style);
            this.sciBanner.BannerFont = newBannerFont;
            newBannerFont.Dispose();
            bannerFont.Dispose();

            this.versionLabel.Text = SciInfo.GetFullAppName();
        }
        ...
        private void InitializeComponent()
        {
            ...
            // pdnBanner
            // 
            this.sciBanner.BannerFont = new System.Drawing.Font("Tahoma", 10F);
            this.sciBanner.BannerText = "headingText";
            this.sciBanner.Location = new System.Drawing.Point(0, 0);
            this.sciBanner.Name = "SciBanner";
            this.sciBanner.Size = new System.Drawing.Size(495, 71);
            this.sciBanner.TabIndex = 7;
            // 
            // versionLabel
            // 
            ...
            this.Controls.Add(this.sciBanner);
            ...
            this.Controls.SetChildIndex(this.sciBanner, 0);
        ...
        private void RichCreditsBox_LinkClicked(object sender, System.Windows.Forms.LinkClickedEventArgs e)
        {
            ...
            {
                SciInfo.OpenUrl(this, e.LinkText);
            }
        }
    }
}
