...
namespace SciImage.PaintForms.LayerForm
{
        ...
        : UserControl
    {
        ...
        {
            get { return DocumentManager.Manager.ActiveDocumentWorkspace;  }
        }
        ...
        public LayerControl()
        {
            this.elementHeight = 6 + UI.ScaleWidth(LayerElement.ThumbSizePreScaling);
        ...
        public void SetupNewDocument(Document newDocument)
        {
            ...
            UI.SuspendControlPainting(this.layerControlPanel);
            ...
            if (FormsManager.BaseForm != null)
            {
                ...
                {
                    if (lec.Layer ==DocumentManager.Manager.  ActiveDocumentWorkspace.ActiveLayer)
                    {
                        lec.IsSelected = true;
                    }
                    else
            ...
            UI.ResumeControlPainting(this.layerControlPanel);
        ...
        //{
        //    SetupNewDocument(DocumentManager.Manager.ActiveDocumentWorkspace.Document);
        //}
        ...
        {
            SetActive(DocumentManager.Manager.ActiveDocumentWorkspace.ActiveLayer);
        }
        ...
        //                DocumentManager.Manager.ActiveDocumentWorkspaceChanging -= Workspace_ActiveDocumentWorkspaceChanging;
        //                DocumentManager.Manager.ActiveDocumentWorkspaceChanged -= Workspace_ActiveDocumentWorkspaceChanged;
        //            }
        ...
        private void Workspace_ActiveDocumentWorkspaceChanging(object sender, EventArgs e)
        {
            ...
            {
                ActiveDocumentWorkspace.DocumentChanging -= documentChangingDelegate;
                ActiveDocumentWorkspace.DocumentChanged -= documentChangedDelegate;
               ActiveDocumentWorkspace.ActiveLayerChanged -= layerChangedDelegate;
            }
        }
        ...
        private void Workspace_ActiveDocumentWorkspaceChanged(object sender, EventArgs e)
        {
            if (ActiveDocumentWorkspace != null)
            {
                ...
                if (ActiveDocumentWorkspace.Document != null)
                {
                    SetupNewDocument(ActiveDocumentWorkspace.Document);
                }
            }
        }
