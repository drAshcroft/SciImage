...
namespace SciImage.Forms
{
        ...
        : Form
    {
        ...
        private bool IsTargetFormActive(object target)
        {
            ...
            //    {
            //        targetControl = null;// asIFormAssociate.AssociatedForm;
            //    }
            //}
        ...
        protected virtual ResourceManager StringsResourceManager
        {
            get
            {
                return SciResources.SciResources.Strings;
            }
        }
        ...
        protected override void OnHandleCreated(EventArgs e)
        {
            ...
            SciBaseForm.EnableOpacityChanged += new EventHandler(EnableOpacityChangedHandler);
        ...
        {
            if (UserSessions.IsRemote || !SciBaseForm.globalEnableOpacity || !this.EnableInstanceOpacity)
            {
