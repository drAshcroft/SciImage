...
namespace SciImage
{
    public sealed class Startup
    {
        ...
        private void StartPart2()
        {
            ...
            {
                string message = SciResources.SciResources.GetString("Error.OSRequirement");
        ...
        private static void UnhandledException(Exception ex)
        {
            ...
            try
            {
                errorFormat = SciResources.SciResources.GetString("Startup.UnhandledError.Format");
            }
        ...
        private static void WriteCrashLog(Exception ex, TextWriter stream)
        {
            ...
            try
            {
                headerFormat = SciResources.SciResources.GetString("CrashLog.HeaderText.Format");
            }
            ...
            try
            {
                try
                {
                    fullAppName = SciInfo.GetFullAppName();
                }
                ...
                {
                    localeName = 
                        "pdnr.c: " + SciResources.SciResources.Culture.Name +
