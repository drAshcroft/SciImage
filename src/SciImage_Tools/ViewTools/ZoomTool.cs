...
namespace SciImage_Tools.ViewTools
{
    /// <summary>
        ...
        : Tool
    {
        ...
        public ZoomTool(DocumentWorkspace documentWorkspace)
            : base(documentWorkspace,
                   SciImage.SciResources.SciResources.GetImageResource("Icons.glyphicons-28-search.png"),
                   "Zoom",
        ...
        {
            this.cursorZoom = new Cursor(SciImage.SciResources.SciResources.GetResourceStream("Cursors.ZoomToolCursor.cur"));
            this.cursorZoomIn = new Cursor(SciImage.SciResources.SciResources.GetResourceStream("Cursors.ZoomInToolCursor.cur"));
            this.cursorZoomOut = new Cursor(SciImage.SciResources.SciResources.GetResourceStream("Cursors.ZoomOutToolCursor.cur"));
            this.cursorZoomPan = new Cursor(SciImage.SciResources.SciResources.GetResourceStream("Cursors.ZoomOutToolCursor.cur"));
