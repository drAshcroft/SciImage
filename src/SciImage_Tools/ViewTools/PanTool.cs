...
namespace SciImage_Tools.ViewTools
{
        ...
        : Tool
    {
        ...
        protected override void OnActivate()
        {
            ...
            this.cursorMouseDown = new Cursor(SciImage.SciResources.SciResources.GetResourceStream("Cursors.PanToolCursorMouseDown.cur"));
            this.cursorMouseUp = new Cursor(SciImage.SciResources.SciResources.GetResourceStream("Cursors.PanToolCursor.cur"));
            this.cursorMouseInvalid = new Cursor(SciImage.SciResources.SciResources.GetResourceStream("Cursors.PanToolCursorInvalid.cur"));
        ...
        public PanTool(DocumentWorkspace documentWorkspace)
            : base(documentWorkspace,
                   SciImage.SciResources.SciResources.GetImageResource("Icons.glyphicons-234-direction.png"),
                   "Pan",
