...
namespace SciImage_Tools.Select
{
        ...
        : MoveToolBase
    {
        ...
        protected override void OnActivate()
        {
            ...
            this.moveToolCursor = new Cursor(SciImage.SciResources.SciResources.GetResourceStream("Cursors.MoveSelectionToolCursor.cur"));
        ...
        protected override void Drop()
        {
            ...
            this.FlushHistoryMementos(SciImage.SciResources.SciResources.GetString("MoveSelectionTool.HistoryMemento.DropSelection"));
        }
        ...
        protected override void OnMouseUp(MouseEventArgs e)
        {
            ...
            string actionName = SciImage.SciResources.SciResources.GetString(resourceName);
        ...
        public MoveSelectionTool(DocumentWorkspace documentWorkspace)
            : base(documentWorkspace,
                   SciImage.SciResources.SciResources.GetImageResource("Icons.glyphicons-187-move.png"),
