...
namespace SciImage_Tools.ShapeTools
{
        ...
        : ShapeTool 
    {
        ...
        {
            this.ellipseToolCursor = new Cursor(SciImage.SciResources.SciResources.GetResourceStream("Cursors.EllipseToolCursor.cur"));
        ...
        public EllipseTool(DocumentWorkspace documentWorkspace)
            : base(documentWorkspace,
                   SciImage.SciResources.SciResources.GetImageResource("Icons.glyphicons-96-vector-path-circle.png"),
                   "Ellipse and Circle",
