...
namespace SciImage_Tools.ShapeTools
{
        ...
        : Tool
    {
        ...
        private SciRegion interiorSaveRegion;
        private SciRegion outlineSaveRegion;
        private List<PointF> points;
        private SciRegion lastDrawnRegion = null;
        ...
        protected override void OnStylusDown(StylusEventArgs  e)
        {
                     ...
                     ((e.Button & MouseButtons.Right) == MouseButtons.Right))
            {
                ...
                using (SciRegion clipRegion = Selection.CreateRegion())
                {
        ...
        protected void RenderShape()
        {
            ...
            PenInfo pi = ToolEnvironment.PenInfo;
            BrushInfo bi = ToolEnvironment.BrushInfo;

            ColorPixelBase primary = ToolEnvironment.PrimaryColor;
            ColorPixelBase secondary = ToolEnvironment.SecondaryColor;

            if (!ForceShapeDrawType && ToolEnvironment.ShapeDrawType == ShapeDrawType.Interior)
            {
            ...
            {
                outlinePen = pi.CreatePen(ToolEnvironment.BrushInfo, primary.ToColor(), secondary.ToColor());
                interiorBrush = bi.CreateBrush(secondary.ToColor(), primary.ToColor());
            }
            else if ((mouseButton & MouseButtons.Right) == MouseButtons.Right)
            {
                outlinePen = pi.CreatePen(ToolEnvironment.BrushInfo, secondary.ToColor(), primary.ToColor());
            ...
            {
                drawType = ToolEnvironment.ShapeDrawType;
            }
            ...
            if (shapePath != null)
            {
                ...
                SciRegion interiorRegion = new SciRegion(shapePath);

                // create non-optimized outline region
                SciRegion outlineRegion;
                ...
                using (PdnGraphicsPath outlinePath = (PdnGraphicsPath)shapePath.Clone())
                {
                    try
                    {
                        ...
                        outlineRegion = new SciRegion(outlinePath);
                    }
                    ...
                    {
                        outlineRegion = new SciRegion(shapePath);
                    }
                }
                ...
                SciRegion invalidOutlineRegion;
                ...
                SciRegion invalidInteriorRegion = Utility.SimplifyAndInflateRegion(interiorRegion, Utility.DefaultSimplificationFactor, 3);

                SciRegion invalidRegion = new SciRegion();
                invalidRegion.MakeEmpty();

                // set up alpha blending
                renderArgs.Graphics.CompositingMode = ToolEnvironment.GetCompositingMode();
        ...
        protected void CommitShape()
        {
            ...
            SciRegion activeRegion = Selection.CreateRegion();

            if (outlineSaveRegion != null)
            {
                using (SciRegion clipTest = activeRegion.Clone())
                {
                       ...
                       ~(toolBarConfigItemsExclude))
        {
            ...
            this.points = null;
            this.cursorMouseUp = new Cursor(SciImage.SciResources.SciResources.GetResourceStream("Cursors.ShapeToolCursor.cur"));
            this.cursorMouseDown = new Cursor(SciImage.SciResources.SciResources.GetResourceStream("Cursors.ShapeToolCursorMouseDown.cur"));
        }
