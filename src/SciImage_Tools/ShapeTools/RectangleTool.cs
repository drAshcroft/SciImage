...
namespace SciImage_Tools.ShapeTools
{
        ...
        : ShapeTool 
    {
        ...
        {
            if (ToolEnvironment.PenInfo.Width == 1.0f)
            {
        ...
        {
            rectangleToolCursor = new Cursor(SciImage.SciResources.SciResources.GetResourceStream("Cursors.RectangleToolCursor.cur"));
        ...
        public RectangleTool(DocumentWorkspace documentWorkspace)
            : base(documentWorkspace,
                   SciImage.SciResources.SciResources.GetImageResource("Icons.glyphicons-100-vector-path-all.png"),
                   "Rectangle Drawing",
