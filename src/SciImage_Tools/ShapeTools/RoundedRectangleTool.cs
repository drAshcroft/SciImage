...
namespace SciImage_Tools.ShapeTools
{
        ...
        : ShapeTool 
    {
        ...
        {
            this.roundedRectangleCursor = new Cursor(SciImage.SciResources.SciResources.GetResourceStream("Cursors.RoundedRectangleToolCursor.cur"));
        ...
        public RoundedRectangleTool(DocumentWorkspace documentWorkspace)
            : base(documentWorkspace,
                   SciImage.SciResources.SciResources.GetImageResource("Icons.glyphicons-95-vector-path-square.png"),
                   "Rounded Rectangle",
