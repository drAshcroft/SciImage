...
using SciImage_Tools.ShapeTools;

namespace SciImage_Tools.LineTools
{
        ...
        : ShapeTool 
    {
        ...
        protected override PdnGraphicsPath CreateShapePath(PointF[] points)
        {
            ...
            else //if (points.Length <= 2)
            {
                ...
                if (units != MeasurementUnit.Pixel)
                {
                    ...
                    unitsAbbreviation = SciImage.SciResources.SciResources.GetString(unitsAbbreviationName);
                    numberFormat = "F2";
                }
                else
                {
        ...
        protected override bool OnWildShortcutKey(int ordinal)
        {
            switch (ordinal)
            {
                case toggleStartCapOrdinal:
                    FormsManager.Manager.ToolConfigStrip.CyclePenStartCap();
                    return true;

                case toggleDashOrdinal:
                    FormsManager.Manager.ToolConfigStrip.CyclePenDashStyle();
                    return true;

                case toggleEndCapOrdinal:
                    FormsManager.Manager.ToolConfigStrip.CyclePenEndCap();
                    return true;
            }
        ...
        protected override bool OnShapeEnd()
        {
            ...
            else
            {
                ...
                string helpText2 = SciImage.SciResources.SciResources.GetString("LineTool.PreCurveHelpText");
        ...
        protected override void OnStylusDown(StylusEventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    string helpText2 = SciImage.SciResources.SciResources.GetString("LineTool.CurvingHelpText");
        ...
        {
            this.lineToolCursor = new Cursor(SciImage.SciResources.SciResources.GetResourceStream("Cursors.LineToolCursor.cur"));
            this.lineToolMouseDownCursor = new Cursor(SciImage.SciResources.SciResources.GetResourceStream("Cursors.GenericToolCursorMouseDown.cur"));
            this.Cursor = this.lineToolCursor;
            ...
            ToolEnvironment.PrimaryColorChanged += new EventHandler(RenderShapeBecauseOfEvent);
            ToolEnvironment.SecondaryColorChanged += new EventHandler(RenderShapeBecauseOfEvent);
            ToolEnvironment.AntiAliasingChanged += new EventHandler(RenderShapeBecauseOfEvent);
            ToolEnvironment.AlphaBlendingChanged += new EventHandler(RenderShapeBecauseOfEvent);
            ToolEnvironment.BrushInfoChanged += new EventHandler(RenderShapeBecauseOfEvent);
            ToolEnvironment.PenInfoChanged += new EventHandler(RenderShapeBecauseOfEvent);
            AppEnvironment.Environment .UnitsChanged += new EventHandler(RenderShapeBecauseOfEvent);
        ...
        public LineTool(DocumentWorkspace documentWorkspace)
            : base(documentWorkspace,
                   SciImage.SciResources.SciResources.GetImageResource("Icons.glyphicons-98-vector-path-line.png"),
                   "Line / Curve",
