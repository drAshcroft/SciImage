...
namespace SciImage_Tools.DrawTools
{
        ...
        : Tool
    {
        ...
        protected override void OnActivate()
        {
            ...
            // cursor-transitions
            this.cursorMouseUp = new Cursor(SciImage.SciResources.SciResources.GetResourceStream("Cursors.EraserToolCursor.cur"));
            this.cursorMouseDown = new Cursor(SciImage.SciResources.SciResources.GetResourceStream("Cursors.EraserToolCursorMouseDown.cur"));
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
                ...
                ((e.Button & MouseButtons.Right) == MouseButtons.Right))
            {
                ...
                SciRegion clipRegion = Selection.CreateRegion();
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            if (mouseDown && ((e.Button & mouseButton) != MouseButtons.None))
            {
                ...
                {
                    alpha = ToolEnvironment.PrimaryColor.alpha ;
                }
                else
                {
                    alpha = ToolEnvironment.SecondaryColor.alpha ;
                }

                Pen pen = ToolEnvironment.PenInfo.CreatePen(ToolEnvironment.BrushInfo,
                ...
                if (saveRect.Width > 0 && saveRect.Height > 0 && renderArgs.Graphics.IsVisible(saveRect))
                {
                    ...
                    new InvertWithAlpha().Apply(renderArgs.Surface, saveRect);
                    ...
                    //BinaryPixelOp bo= new SetColorChannels();
        ...
        public CubistTool(DocumentWorkspace documentWorkspace) 
            : base(documentWorkspace,
                   SciImage.SciResources.SciResources.GetImageResource("Icons.glyphicons-485-send-backward.png"),
                   "Draw cubist",
                   "Click and drag", //"Click and drag to erase a portion of the image",
                   '-',3,
                   false,
