        ...
        : Tool
    {
        ...
        public CloneStampTool(DocumentWorkspace documentWorkspace) 
            : base(documentWorkspace,
                   SciImage.SciResources.SciResources.GetImageResource("Icons.glyphicons-31-stamp.png"),
                   "Stamp",
        ...
        protected override void OnActivate()
        {
            ...
            cursorMouseDownSetSource = new Cursor(SciImage.SciResources.SciResources.GetResourceStream("Cursors.CloneStampToolCursorSetSource.cur"));
            cursorMouseUp = new Cursor(SciImage.SciResources.SciResources.GetResourceStream("Cursors.CloneStampToolCursor.cur"));
