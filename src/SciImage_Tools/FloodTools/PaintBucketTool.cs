...
namespace SciImage_Tools.FloodTools
{
        ...
        : FloodToolBase
    {
        ...
        {
            // cursor-transitions
            cursorMouseUp = new Cursor(SciImage.SciResources.SciResources.GetResourceStream("Cursors.PaintBucketToolCursor.cur"));
            Cursor = cursorMouseUp;
        ...
        public PaintBucketTool(DocumentWorkspace documentWorkspace)
            : base(documentWorkspace,
                   SciImage.SciResources.SciResources.GetImageResource("Icons.glyphicons-541-paintbucket.png"),
                   "Fill Tool",
