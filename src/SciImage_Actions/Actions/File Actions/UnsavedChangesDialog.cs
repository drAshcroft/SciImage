...
namespace SciImage_Actions.Actions.File_Actions
{
        ...
        : SciBaseForm
    {
        ...
        {
            this.Text = SciImage.SciResources.SciResources.GetString("UnsavedChangesDialog.Text");
            this.Icon = Utility.ImageToIcon(SciImage.SciResources.SciResources.GetImageResource("Icons.WarningIcon.png").Reference, false);

            this.infoLabel.Text = SciImage.SciResources.SciResources.GetString("UnsavedChangesDialog.InfoLabel.Text");
            this.documentListHeader.Text = SciImage.SciResources.SciResources.GetString("UnsavedChangesDialog.DocumentListHeader.Text");
            
            this.saveButton.ActionText = SciImage.SciResources.SciResources.GetString("UnsavedChangesDialog.SaveButton.ActionText");
            this.saveButton.ExplanationText = SciImage.SciResources.SciResources.GetString("UnsavedChangesDialog.SaveButton.ExplanationText");
            this.saveButton.ActionImage = SciImage.SciResources.SciResources.GetImageResource("Icons.UnsavedChangesDialog.SaveButton.png").Reference;

            this.dontSaveButton.ActionText = SciImage.SciResources.SciResources.GetString("UnsavedChangesDialog.DontSaveButton.ActionText");
            this.dontSaveButton.ExplanationText = SciImage.SciResources.SciResources.GetString("UnsavedChangesDialog.DontSaveButton.ExplanationText");
            this.dontSaveButton.ActionImage = SciImage.SciResources.SciResources.GetImageResource("Icons.MenuFileCloseIcon.png").Reference;

            this.cancelButton.ActionText = SciImage.SciResources.SciResources.GetString("UnsavedChangesDialog.CancelButton.ActionText");
            this.cancelButton.ExplanationText = SciImage.SciResources.SciResources.GetString("UnsavedChangesDialog.CancelButton.ExplanationText");
            this.cancelButton.ActionImage = SciImage.SciResources.SciResources.GetImageResource("Icons.CancelIcon.png").Reference;
        ...
        private void InitializeComponent()
        {
            ...
            this.documentListHeader = new HeaderLabel();
