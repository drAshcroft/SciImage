...
using SciImage.Core;
using SciImage_Actions.Actions.Image_Actions;
...
namespace SciImage_Actions.Actions.File_Actions
{
        ...
        : ResizeDialog
    {
        ...
        {
            InitializeComponent();
            this.Icon = Utility.ImageToIcon(SciImage.SciResources.SciResources.GetImageResource("Icons.MenuFileNewIcon.png").Reference, Utility.TransparentKey);
            this.Text = "New"; // "New";
        }
