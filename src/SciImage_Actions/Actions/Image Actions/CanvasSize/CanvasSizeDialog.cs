...
namespace SciImage_Actions.Actions.Image_Actions.CanvasSize
{
        ...
        : ResizeDialog
    {
        ...
        private HeaderLabel anchorHeader;
        ...
        public CanvasSizeDialog()
        {
            ...
            this.Icon = Utility.ImageToIcon(SciImage.SciResources.SciResources.GetImageResource("Icons.MenuImageCanvasSizeIcon.png").Reference, Utility.TransparentKey);

            this.Text = SciImage.SciResources.SciResources.GetString("CanvasSizeDialog.Text"); // "Canvas Size";
            this.anchorHeader.Text = SciImage.SciResources.SciResources.GetString("CanvasSizeDialog.AnchorHeader.Text"); //"Anchor";
            this.newSpaceLabel.Text = SciImage.SciResources.SciResources.GetString("CanvasSizeDialog.NewSpaceLabel.Text"); //"The new space will be filled with the currently selected background color.";
        ...
        private void InitializeComponent()
        {
            ...
            this.anchorHeader = new HeaderLabel();
