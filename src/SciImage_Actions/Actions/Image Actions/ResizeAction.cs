...
namespace SciImage_Actions.Actions.Image_Actions
{
        ...
        : PluginAction
    {
        ...
        private static ImageResource StaticImage
        {
            get
            {
                return SciImage.SciResources.SciResources.GetImageResource("Icons.MenuImageResizeIcon.png");
            }
        }
            ...
            : CallbackWithProgressDialog
        {
            ...
            public ResizeProgressDialog(Control owner, Document dst, Document src, Size newSize, ResamplingAlgorithm algorithm)
                : base (owner, SciInfo.GetBareProductName(), SciImage.SciResources.SciResources.GetString("ResizeAction.ProgressDialog.Description"))
            {
                this.dst = dst;
                this.src = src;
            ...
            public bool DoResize()
            {
                ...
                {
                    Utility.ErrorBox(this.Owner, SciImage.SciResources.SciResources.GetString("ResizeAction.PerformAction.UnspecifiedError"));
                }
        ...
        public override bool PerformAction( List<HistoryMemento> OptionalHistoryRecord, int TargetLayerIndex)
        {
            ...
            using (ResizeDialog rd = new ResizeDialog())
            {
                ...
                if (newDpuUnit != MeasurementUnit.Pixel)
                {
                    ...
                    {
                        AppEnvironment.Environment.Units = newDpuUnit;
                    }
                }
            ...
            else
            {
                ...
                catch (WorkerThreadException ex)
                {
                    ...
                    {
                        Utility.ErrorBox(documentWorkspace, SciImage.SciResources.SciResources.GetString("ResizeAction.PerformAction.OutOfMemory"));
                        return false ;
                    }
                    else
                    {
