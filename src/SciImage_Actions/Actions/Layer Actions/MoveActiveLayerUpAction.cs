...
namespace SciImage_Actions.Actions.Layer_Actions
{
        ...
        : PluginAction
    {
        private static string StaticName
        {
            get
            {
                return SciImage.SciResources.SciResources.GetString("MoveLayerUp.HistoryMementoName");
            }
        }
        ...
        private static ImageResource StaticImage
        {
            get
            {
                return SciImage.SciResources.SciResources.GetImageResource("Icons.MenuLayersMoveLayerUpIcon.png");
            }
        }
